...
class PoizonscraperSpiderMiddleware:
...
class PoizonscraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_endpoints = settings.get(
        ...
        self.scrapeops_num_results = settings.get(
    ...
    def _get_user_agents_list(self):
        ...
        response = requests.get(self.scrapeops_endpoints, params=urlencode(payload))
...
class ScrapeOpsFakeBrowerHeaderAgentMiddleware:
    @classmethod
    def from_crawler(cls, crawler):
        return cls(crawler.settings)
